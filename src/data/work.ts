...
export const projects: Project[] = [
  {
    ...
    title: "Archives BIA",
    description: "WEBSITE",
    tech: "React, NestJS, Tailwind, PostgreSQL, MinIO, Redis, Docker",
    ...
    fullDescription:
      "ระบบจัดการคลังจดหมายเหตุดิจิทัลระดับองค์กร (Enterprise Digital Archives Management System) ที่ออกแบบมาเพื่อการจัดเก็บ จัดการ และเผยแพร่เอกสารจดหมายเหตุตามมาตรฐานสากล ISAD-G (General International Standard Archival Description) รองรับการใช้งานตั้งแต่ระดับผู้ใช้ทั่วไปจนถึงผู้ดูแลระบบและเจ้าหน้าที่จดหมายเหตุ",
    features: [
      "ระบบบริการและสืบค้นเอกสารจดหมายเหตุตามโครงสร้างแบบลำดับชั้นมาตรฐาน ISAD-G",
      "ระบบค้นหาขั้นสูง (Advanced Search Engine) พร้อมตัวกรองข้อมูลและการสืบค้นผ่านรหัสเอกสาร",
      "ระบบขอสำเนาเอกสารจดหมายเหตุออนไลน์พร้อมเวิร์กโฟลว์แจ้งเตือนผ่านอีเมล",
      "ระบบจัดการเอกสาร 3 ประเภทหลัก: สิ่งพิมพ์รวบรวม (Publication), ลายลักษณ์ (Manuscript), วัตถุจดหมายเหตุ (Artifact)",
      "ฟีเจอร์อิมพอร์ตข้อมูล Metadata จำนวนมากผ่านไฟล์ Excel (Batch Import)",
      "ระบบจัดเก็บไฟล์ดิจิทัลที่ปลอดภัยด้วย Presigned URLs (MinIO Object Storage)",
      "ระบบยืนยันตัวตนหลากหลายแบบและ Single Sign-On (SSO) ผ่าน OpenID Connect",
      "การควบคุมสิทธิ์การเข้าถึงข้อมูลตามบทบาทหน้าที่แบบ 4 ระดับ (Role-Based Access Control)",
    ],
    year: "2025",
