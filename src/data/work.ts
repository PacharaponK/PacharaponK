...
export const projects: Project[] = [
  {
    ...
    fullDescription:
      "ระบบจัดการคลังจดหมายเหตุดิจิทัลระดับองค์กร (Enterprise Digital Archives Management System) ที่ออกแบบมาเพื่อการจัดเก็บ จัดการ และเผยแพร่เอกสารจดหมายเหตุ รองรับการใช้งานตั้งแต่ระดับผู้ใช้ทั่วไปจนถึงผู้ดูแลระบบและเจ้าหน้าที่จดหมายเหตุ",
    features: [
      "ระบบบริการและสืบค้นเอกสารจดหมายเหตุตามโครงสร้างแบบลำดับชั้น",
