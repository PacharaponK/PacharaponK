...
export const activities: Activity[] = [
  ...
  },
  {
    ...
    year: "2024",
    type: "Competition",
    description: "เป็นตัวแทนมหาวิทยาลัยสงขลานครินทร์ในการแข่งขัน ICPC Thailand National Round 2024 ณ จุฬาลงกรณ์มหาวิทยาลัย ร่วมทีม 3 คนเพื่อแก้ปัญหา Algorithms และ Data Structures ภายใต้เงื่อนไขเวลาจำกัดในระดับประเทศ",
    images: [
      "/image/activities/icpc/1773110981017.jpg",
      "/image/activities/icpc/1773110981400.jpg",
      "/image/activities/icpc/1773110981441.jpg",
    ],
    result: "National Round Qualifier",
